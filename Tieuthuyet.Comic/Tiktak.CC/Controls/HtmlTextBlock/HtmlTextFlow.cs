...
using Tiktak.CC.Helpers;

namespace Tiktak.CC.Controls
{
    [TemplatePart(Name = PART_ItemsControl, Type = typeof(ItemsControl))]
    public class HtmlTextFlow : Control
    {
        private ItemsControl internalItemsControl;

        private const string PART_ItemsControl = "PART_ItemsControl2";

        static HtmlTextFlow()
        {
            HtmlProperty = DependencyProperty.Register("Html", typeof(string), typeof(HtmlTextFlow), new PropertyMetadata(HtmlChanged));
            NavigationCommandProperty = DependencyProperty.Register("NavigationCommand", typeof(ICommand), typeof(HtmlTextFlow), new PropertyMetadata(NavigationCommandChanged));

            DefaultFontFamilyProperty = DependencyProperty.Register("DefaultFontFamily", typeof(FontFamily), typeof(HtmlTextFlow), new PropertyMetadata(null));
            DefaultFontSizeProperty = DependencyProperty.Register("DefaultFontSize", typeof(double?), typeof(HtmlTextFlow), new PropertyMetadata(DefaultFontSizeChanged));
            DefaultFontStretchProperty = DependencyProperty.Register("DefaultFontStretch", typeof(FontStretch), typeof(HtmlTextFlow), new PropertyMetadata(null));
            DefaultFontStyleProperty = DependencyProperty.Register("DefaultFontStyle", typeof(FontStyle), typeof(HtmlTextFlow), new PropertyMetadata(null));
            DefaultFontWeightProperty = DependencyProperty.Register("DefaultFontWeight", typeof(FontWeight), typeof(HtmlTextFlow), new PropertyMetadata(null));
            DefaultForegroundProperty = DependencyProperty.Register("DefaultForeground", typeof(Brush), typeof(HtmlTextFlow), new PropertyMetadata(null));

            HyperlinkFontFamilyProperty = DependencyProperty.Register("HyperlinkFontFamily", typeof(FontFamily), typeof(HtmlTextFlow), new PropertyMetadata(null));
            HyperlinkFontSizeProperty = DependencyProperty.Register("HyperlinkFontSize", typeof(double?), typeof(HtmlTextFlow), new PropertyMetadata(null));
            HyperlinkFontStretchProperty = DependencyProperty.Register("HyperlinkFontStretch", typeof(FontStretch), typeof(HtmlTextFlow), new PropertyMetadata(null));
            HyperlinkFontStyleProperty = DependencyProperty.Register("HyperlinkFontStyle", typeof(FontStyle), typeof(HtmlTextFlow), new PropertyMetadata(null));
            HyperlinkFontWeightProperty = DependencyProperty.Register("HyperlinkFontWeight", typeof(FontWeight), typeof(HtmlTextFlow), new PropertyMetadata(null));
            HyperlinkForegroundProperty = DependencyProperty.Register("HyperlinkForeground", typeof(Brush), typeof(HtmlTextFlow), new PropertyMetadata(null));

            H1FontFamilyProperty = DependencyProperty.Register("H1FontFamily", typeof(FontFamily), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H1FontSizeProperty = DependencyProperty.Register("H1FontSize", typeof(double?), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H1FontStretchProperty = DependencyProperty.Register("H1FontStretch", typeof(FontStretch), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H1FontStyleProperty = DependencyProperty.Register("H1FontStyle", typeof(FontStyle), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H1FontWeightProperty = DependencyProperty.Register("H1FontWeight", typeof(FontWeight), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H1ForegroundProperty = DependencyProperty.Register("H1Foreground", typeof(Brush), typeof(HtmlTextFlow), new PropertyMetadata(null));

            H2FontFamilyProperty = DependencyProperty.Register("H2FontFamily", typeof(FontFamily), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H2FontSizeProperty = DependencyProperty.Register("H2FontSize", typeof(double?), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H2FontStretchProperty = DependencyProperty.Register("H2FontStretch", typeof(FontStretch), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H2FontStyleProperty = DependencyProperty.Register("H2FontStyle", typeof(FontStyle), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H2FontWeightProperty = DependencyProperty.Register("H2FontWeight", typeof(FontWeight), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H2ForegroundProperty = DependencyProperty.Register("H2Foreground", typeof(Brush), typeof(HtmlTextFlow), new PropertyMetadata(null));

            H3FontFamilyProperty = DependencyProperty.Register("H3FontFamily", typeof(FontFamily), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H3FontSizeProperty = DependencyProperty.Register("H3FontSize", typeof(double?), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H3FontStretchProperty = DependencyProperty.Register("H3FontStretch", typeof(FontStretch), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H3FontStyleProperty = DependencyProperty.Register("H3FontStyle", typeof(FontStyle), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H3FontWeightProperty = DependencyProperty.Register("H3FontWeight", typeof(FontWeight), typeof(HtmlTextFlow), new PropertyMetadata(null));
            H3ForegroundProperty = DependencyProperty.Register("H3Foreground", typeof(Brush), typeof(HtmlTextFlow), new PropertyMetadata(null));

            BlockQuoteBackgroundProperty = DependencyProperty.Register("BlockQuoteBackground", typeof(Brush), typeof(HtmlTextFlow), new PropertyMetadata(null));
        }

        public HtmlTextFlow()
        {
            DefaultStyleKey = typeof(HtmlTextFlow);
        ...
        {
            HtmlTextFlow instance = (HtmlTextFlow)o;
            if (instance != null && instance.internalItemsControl != null)
        ...
        private static void DefaultFontSizeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            HtmlTextFlow instance = (HtmlTextFlow)d;
            if (instance.internalItemsControl != null)
            {
                foreach (var item in instance.internalItemsControl.Items)
                {
                    (item as Control).FontSize = instance.DefaultFontSize ?? instance.FontSize;
                }
            }
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            internalItemsControl = (ItemsControl)base.GetTemplateChild(HtmlTextFlow.PART_ItemsControl);
        ...
        private void AppendHtml2(string html)
        {
        ...
        private void AppendRichtextBox(HtmlNode node)
        {
            ...
            rtb.FontFamily = this.DefaultFontFamily ?? this.FontFamily;
            rtb.FontSize = this.DefaultFontSize ?? this.FontSize;
            rtb.FontStretch = this.DefaultFontStretch;
            rtb.FontStyle = this.DefaultFontStyle;
            rtb.FontWeight = this.DefaultFontWeight;// this.FontWeight;
            rtb.Foreground = this.DefaultForeground;// this.Foreground;
        ...
        #region Textrange Limitation Workaround
